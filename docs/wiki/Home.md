...
```mermaid
flowchart LR
    Q["Discovery<br/>17 junction questions"] --> G["graph_generator<br/>agent-graph.yml"]
...
| Graph edges | **10** routing and hand-off edges, plus an optional Jira self-gate |
| Junction questions | **17**, cloud-agnostic, in 7 groups: profile, platform, discovery, naming, data stores, agent graph, secrets |
